...
The following rules will read the status of the Riverbed and alert users to important conditions.

The ruleset should be scheduled as a chassis monitor with the command **config monitor chassis RBTest**.

Copy and paste the following text into your CLI.
...
action event GENERIC4 -a "Services Degraded"
...
action event GENERIC5 -a "service Critical"
...
action event GENERIC4 -a "inpath is not Up"
...
action event GENERIC5 -a "Lan0_0 link down"
...
action event GENERIC6 -a "Wan0_0 link down"
...
action event GENERIC6 -a "Link State ERROR"
...
action event GENERIC6 -a "Bypass State ERROR"
